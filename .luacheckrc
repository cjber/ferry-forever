...
-- Trail.lua: the camera distance, mouselook (yaw = facing) and the view it projects into.
read_globals[#read_globals + 1] = "GetCameraZoom"
read_globals[#read_globals + 1] = "IsMouselooking"
read_globals[#read_globals + 1] = "WorldFrame"
read_globals[#read_globals + 1] = "C_CVar"
