...
-- At release the packager fills each block with that language's translations from the CurseForge project, one
-- assignment into L per phrase. In a checkout the blocks are empty, L goes unused and every phrase reads as English.
-- luacheck: ignore 211 542
